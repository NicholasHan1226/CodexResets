/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 14b0e89109669627e05a2afa4870a6ae)
...
interface __BaseEnv_Env {
	...
	FORECAST_LEDGER: DurableObjectNamespace<import("./src/index").ForecastLedger>;
	PIPELINE_COORDINATOR: DurableObjectNamespace<import("./src/index").PipelineCoordinator>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "RateLimiter" | "ForecastLedger" | "PipelineCoordinator";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SITE_URL" | "PUBLIC_URL" | "TARGET_ACCOUNT" | "VAPID_SUBJECT" | "VAPID_PUBLIC_KEY" | "RESEND_FROM" | "RSSHUB_INSTANCES" | "SUPABASE_URL" | "SUPABASE_ANON_KEY">> {}
}
