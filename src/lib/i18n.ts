...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'curve.distributionHint': 'This chart is timing density; the overall probability is shown in the hero card.',
    'curve.mostLikelyWindow': 'Most likely window',
    'curve.peak': 'Peak',
    'curve.peakWindow': 'Single 3h peak',
    'curve.window': 'next {n}h',
    'curve.sparseTiming': 'Too few observations to identify a precise reset window',
    'curve.likeliestTime': 'History-based model peak: {time}',
  ...
  zh: {
    ...
    'curve.distributionHint': '此图为时间段概率分布；总重置概率在上方主卡显示。',
    'curve.mostLikelyWindow': '最可能窗口',
    'curve.peak': '峰值',
    'curve.peakWindow': '单个 3 小时峰值',
    'curve.window': '未来 {n} 小时',
    'curve.sparseTiming': '样本较少，暂不标注精确重置窗口',
    'curve.likeliestTime': '历史模型集中时段：{time}',
