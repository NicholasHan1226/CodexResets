...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'account.description': 'Optional. Sign in to sync your usage tracking and banked resets across devices. Everything works without an account — data stays in this browser.',
    'account.needAccount': 'need an account? sign up',
    'account.haveAccount': 'have an account? sign in',
    'account.signupOk': 'Account created — you are signed in.',
    'account.syncing': 'syncing…',
    'account.synced': 'synced {time}',
    'account.syncError': 'sync failed — local data is safe',
  ...
  zh: {
    ...
    'account.title': '## 账户',
    'account.description': '可选。登录后用量追踪与存储重置记录可跨设备同步。不登录一切照常——数据仅保存在当前浏览器。',
    'account.needAccount': '没有账户？注册',
    'account.haveAccount': '已有账户？登录',
    'account.signupOk': '注册成功——已自动登录。',
    'account.syncing': '同步中…',
    'account.synced': '已同步 {time}',
    'account.syncError': '同步失败——本地数据完好',
