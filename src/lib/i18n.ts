...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'curve.peak': 'Peak',
    'curve.peakWindow': 'Highest 3h window',
    ...
    'subscribe.description': 'We’ll email when a reset is confirmed. Confirm your email first.',
  ...
  zh: {
    ...
    'subscribe.description': '重置确认后将发送邮件提醒。请先完成邮箱确认。',
    'subscribe.command': 'watch confirmed-resets --channel email',
    'subscribe.armed': '已生效',
