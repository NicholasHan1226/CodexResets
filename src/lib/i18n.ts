...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'curve.peak': 'Peak',
    'curve.peakWindow': 'Highest window',
    ...
    'subscribe.command': 'watch resets --window 24h --threshold 70% --channel email',
    'subscribe.nowLabel': 'current 24h',
